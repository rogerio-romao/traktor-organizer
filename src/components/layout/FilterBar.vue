...
function getDefaultPlaylistName(): string {
    ...
    if (nonTagCount === 1 && tagCount === 0) {
        ...
        if (hasKey) return `${formatKey(keyFilter ?? '', 'standard')} Scale`;
    ...
    <div class="filter-bar">
        <div class="filter-controls">
            <select
                ...
                @change="
                    tracksStore.genreFilter = ($event.target as HTMLSelectElement).value || null
                "
            >
            ...
            <select
                ...
                @change="
                    tracksStore.ratingFilter = ($event.target as HTMLSelectElement).value
        ...
        <div v-if="tracksStore.activeTagFilters.length > 0" class="tag-pills">
            ...
            <span v-for="tag in tracksStore.activeTagFilters" :key="tag" class="filter-pill">
                {{ tag }}
                <button
                    class="filter-remove"
                    @click="
