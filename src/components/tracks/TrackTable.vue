...
<template>
    <div
        class="track-table-wrapper"
        :style="isDragging ? { cursor: 'grabbing', userSelect: 'none' } : {}"
    >
                ...
                <div v-else-if="rows.length === 0" class="empty-state">
                    {{
                        props.tracks !== undefined
                            ...
                            : tracksStore.allTracks.length === 0
                ...
                >
                    ...
                    >
                        <template v-if="rows[vRow.index]">
                            ...
                            >
                                <span
                                    v-if="cell.column.id === 'rowNumber'"
                                    class="cell-text row-number"
                                >
                                    {{ vRow.index + 1 }}
                                </span>
                                <CoverArtCell
