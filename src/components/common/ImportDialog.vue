...
import { ref } from 'vue'
import { useImport, type ImportStats } from '../../composables/useImport'
          ...
          <template v-else-if="stats">
            <div class="stats">
              ...
              <div class="stat-row new">
                ...
                <span class="stat-value">{{ stats.inserted.toLocaleString() }}</span>
              </div>
...
.stat-label { color: var(--text-secondary, #999); }
...
.btn-primary:hover { background: var(--accent-dim, #cc5200); }
...
.btn-secondary:hover { color: var(--text-primary, #e0e0e0); }
</style>
