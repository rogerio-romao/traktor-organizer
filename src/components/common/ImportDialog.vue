<script setup lang="ts">
    ...
    const { isImporting, progress, progressLabel, error, pickAndImport } =
        useImport();
            ...
            <div class="dialog">
                ...
                <div class="dialog-body">
                    ...
                    <template v-if="!isImporting && !stats">
                        <p class="hint">
                            Select your <code>collection.nml</code> file from
                            your Traktor folder. The app will default to your
                            last used location, or
                            <code>Documents/Native Instruments</code> if this is
                            your first import.
                        </p>
