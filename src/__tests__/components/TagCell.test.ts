...
vi.mock('@/composables/useContextMenu', () => ({
    useContextMenu: (): { show: typeof mockContextMenuShow } => ({
        show: mockContextMenuShow,
    }),
}));
vi.mock('@/composables/usePlaylistSave', () => ({
    usePlaylistSave: (): { open: typeof mockPlaylistSaveOpen } => ({
        open: mockPlaylistSaveOpen,
    }),
}));
vi.mock('@/composables/useTagEditor', () => ({
    useTagEditor: (): { open: typeof mockTagEditorOpen } => ({
        open: mockTagEditorOpen,
    }),
}));
